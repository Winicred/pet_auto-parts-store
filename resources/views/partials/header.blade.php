<div class="bg-base-100 w-full fixed top-0 left-0 z-[2] border-b border-b-base-300 shadow">
    <div class="navbar container items-center mx-auto hidden lg:flex">
        <div class="navbar-start">
            <a href="{{ route('home') }}" class="btn btn-ghost font-semibold normal-case text-xl flex gap-0">
          ...
          <div class="dropdown dropdown-end ml-5">
            ...
            <ul tabindex="0"
              ...
              @if(auth()->user() && auth()->user()->canAccessFilament())
                <li>
                  <a class="font-medium gap-2" href="{{ url('/admin') }}">
      ...
      <div class="hidden w-full" id="navbar-hamburger">
        @if(auth()->user())
          <div class="flex p-2 gap-3 items-center">
            <img data-src="{{ asset('images/users/' . auth()->user()->avatar) }}" alt="Logo"
                 class="w-10 h-10 rounded-full aspect-square lazy-image">
        ...
        <ul class="flex flex-col rounded-lg mt-2 pt-2 border-t border-t-primary">
          <li>
            <a href="{{ route('home') }}"
