...
Route::get("language/{locale}", [LanguageController::class, 'toggleLanguage'])->name("language");
...
Route::get("/{car:slug}/{model:slug}/{category:slug}/{modification:id?}", [PartsController::class, "index"])->name("car.parts.byCategory")->whereNumber("id");
